          ...
          {picks?.length === 0 ? (
            ...
            <>
              ...
              <motion.div
                ...
                className="md:col-span-8 w-full md:max-w-[calc((100vh-180px)*0.667)] md:mx-auto relative group will-change-transform"
              >
              ...
              <div className="md:col-span-4 grid grid-cols-2 md:grid-cols-1 gap-2 lg:gap-3 self-start">
                {picks.slice(1).map((pick, idx) => (
                  <motion.div
                    ...
                    className="w-full md:max-w-[calc(((100vh-220px)/2)*0.667)] md:mx-auto relative group will-change-transform"
                  >
                    <button
